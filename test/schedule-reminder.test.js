...
const locals = {
  musalla: { id: 7, guid: 'demo', name: 'Demo', address: '', timetable_url: '', logo_url: '', jumuah_1_enabled: 0, jumuah_2_enabled: 0, jumuah_3_enabled: 0 },
  ...
  baseUrl: 'http://localhost:3000', path: '/musallas/7', notice: null,
  musallaNav: { id: 7 }, canManageMembers: true, pendingApprovalCount: 0,
...
test('only Musalla admins see the schedule reminder action', async () => {
  ...
  assert.match(adminHtml, /action="\/musallas\/7\/remind-imams"/);
